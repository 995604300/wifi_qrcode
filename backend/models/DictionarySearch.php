...
/**
 * DictionarySearch represents the model behind the search form of `backend\models\Dictionary`.
 */
class DictionarySearch extends Dictionary
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['name', 'type', 'value', 'code', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'name', $this->name])->andFilterWhere(['like', 'type', $this->type])
              ->andFilterWhere(['like', 'value', $this->value])->andFilterWhere(['like', 'code', $this->code]);
