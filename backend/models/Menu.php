...
class Menu extends \yii\db\ActiveRecord
{
    ...
    {
        $menu = Yii::$app->db->createCommand("SELECT * FROM `rly_menu` WHERE parent='0' ")->queryAll();
        return $menu;
    }
    ...
    {
        $menu = Yii::$app->db->createCommand("SELECT * FROM `rly_menu` ORDER BY sort ASC ")->queryAll();
    ...
    public function getLeftMenuList()
    {
        ...
        $menu = Yii::$app->db->createCommand("SELECT * FROM `rly_menu` WHERE route IN ($RolesList)  ORDER BY `order` ASC")
                             ->queryAll();
        //$menu = Yii::$app->db->createCommand("SELECT * FROM `hj_menu`  ORDER BY `order` ASC")->queryAll();
    ...
    {
        $router = Yii::$app->db->createCommand("SELECT * FROM `rly_menu` WHERE id='$id'")->queryOne();
        return $router['route'];
    }
