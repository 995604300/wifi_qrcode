...
class AuthItem extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['name'],'match','pattern' =>'/^[^\/](.*)$/','message'=>'非法权限名'],
            [['type','order'], 'integer'],
            [['description', 'data', 'ruleName','parentid'], 'default'],
            [['name'], 'string', 'max' => 64],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'parentid' => Yii::t('rbac-admin', 'Parentid'),
    ...
    public function save()
    {
        if ($this->validate()) {
            ...
            $this->_item->parentid = $this->parentid;
            $this->_item->order = $this->order;
